...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const zh = {
      ...
      deleteBulkOkOpen: '已永久删除 {n} 个会话，其中 {m} 个当前已打开，界面副本将在重启 dsh 后消失',
    ...
    const en = {
      ...
      deleteBulkOkOpen: 'Permanently deleted {n} sessions; {m} of them are still open and disappear after the next dsh restart',
      ...
      return React.createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: '20px', maxWidth: '760px' } },
        ...
        React.createElement('section', { style: { display: 'flex', flexDirection: 'column', gap: '8px' } },
          React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: '8px' } },
            ...
            }, React.createElement(IconTrashOutline16, { size: 16 }), format(t, 'deleteSelected', { n: selectedRows.length })),
            React.createElement('button', {
              type: 'button',
